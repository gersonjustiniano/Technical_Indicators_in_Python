...
class Alligator:
    ...
    def get_data(self,var):
        for i in range(self.n):
            ...
            if self.calc_type=='dict':
                self.indi.alligator_dict([5,8,13],var)

            self.print_data(var)

        if self.calc_type=='pandas':
            self.indi.alligator_pandas([5,8,13],var)
    ...
    def plot_data(self,var):
        ...
        #plot alligator:
        ax1.plot(var['time'],var['lips'],c='g',lw=1)
        ax1.plot(var['time'],var['teeth'],c='r',lw=1)
        ax1.plot(var['time'],var['jaw'],c='b',lw=1)
