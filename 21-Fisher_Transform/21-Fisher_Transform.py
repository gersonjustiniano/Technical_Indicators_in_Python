...
class FISHER:
    ...
    def get_data(self,var):
        for i in range(self.n):
            ...
            if self.calc_type=='dict':
                self.indi.fisher_dict(20,var)

            self.print_data(var)
        
        if self.calc_type=='pandas':
            self.indi.fisher_pandas(20,var)
    ...
    def plot_data(self,var):
        ...
        ax2.plot(var['time'],var['fisher20'],c='b',lw=1)
        ax2.plot(var['time'],var['fisher_signal20'],c='r',lw=1)
