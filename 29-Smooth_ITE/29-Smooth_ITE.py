...
class Smooth_ITE:
    def __init__(self):
        self.n=100
        self.fig=plt.figure()
        self.title='Smooth Instantaneous Trendline Ehlers'
    ...
    def get_data(self,var):
        for i in range(self.n):
            ...
            if self.calc_type=='dict':
                self.indi.SmoothITE_dict('close',0.1,var)

            self.print_data(var)
        
        if self.calc_type=='pandas':
            self.indi.SmoothITE_pandas('close',0.1,var)
    ...
    def plot_data(self,var):
        ...
        #plot Smooth ITE:
        ax1.plot(var['time'],var['smooth_ite'],c='r',lw=2)
